...
var map__26245 = cljs.core.deref.call(null,game.core.context);
...
var state = cljs.core.get.call(null,map__26245__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
...
var s_26249 = ["Score: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"score","score",-1963588780).cljs$core$IFn$_invoke$arity$1(patient))].join('');
if(cljs.core._EQ_.call(null,s_26249,game.core.score_text.text)){
} else {
game.core.score_text.text = s_26249;
}

var s_26250 = ["Lives Remaining: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"lives-remaining","lives-remaining",-518036388).cljs$core$IFn$_invoke$arity$1(patient))].join('');
if(cljs.core._EQ_.call(null,s_26250,game.core.lives_text.text)){
} else {
game.core.lives_text.text = s_26250;
}
...
game.core.run.call(null,game.pixi.init.call(null,new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, ["textures/PlatformTiles.png","textures/Spike.png","textures/Sprites/Patient/Idle.png","textures/Sprites/Patient/Die.png","textures/Sprites/Patient/Jump.png","textures/Sprites/Patient/Run.png","textures/Sprites/Beldam/Idle.png","textures/Sprites/Beldam/Die.png","textures/Sprites/Beldam/Run.png","textures/Sprites/Nurse/Run.png"], null),(function (){
