...
game.editor.fill_tiles = (function game$editor$fill_tiles(){
...
game.editor.fill_tiles.call(null);
...
return game.editor.run.call(null,game.pixi.init.call(null),game.editor.update_STAR_,game.camera.container);
}
});
