...
goog.provide('game.gemstone');
goog.require('cljs.core');
goog.require('cljs.core.constants');
goog.require('game.tile_map');
goog.require('game.animation_strip');
goog.require('game.game_object');
game.gemstone.texture_path = (function game$gemstone$texture_path(){
return "textures/";
});
game.gemstone.new_gemstone = (function game$gemstone$new_gemstone(cell_x,cell_y){
var ob = game.game_object.new_game_object.call(null);
var animations = new cljs.core.PersistentArrayMap(null, 1, ["idle",game.animation_strip.update_animation_strip.call(null,cljs.core.assoc.call(null,game.animation_strip.new_animation_strip.call(null,game.gemstone.texture_path.call(null),(48),"idle"),cljs.core.cst$kw$loop_DASH_animation_QMARK_,true,cljs.core.cst$kw$frame_DASH_delay,0.15))], null);
...
//# sourceMappingURL=gemstone.js.map?rel=1545202182073
