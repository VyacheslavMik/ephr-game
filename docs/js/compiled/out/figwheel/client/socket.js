...
}catch (e68249){if((e68249 instanceof Error)){
var e = e68249;
return null;
} else {
throw e68249;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__68250){
var map__68251 = p__68250;
var map__68251__$1 = (((((!((map__68251 == null))))?(((((map__68251.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68251.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68251):map__68251);
var opts = map__68251__$1;
var retry_count = cljs.core.get.call(null,map__68251__$1,cljs.core.cst$kw$retry_DASH_count);
var retried_count = cljs.core.get.call(null,map__68251__$1,cljs.core.cst$kw$retried_DASH_count);
var websocket_url = cljs.core.get.call(null,map__68251__$1,cljs.core.cst$kw$websocket_DASH_url);
var build_id = cljs.core.get.call(null,map__68251__$1,cljs.core.cst$kw$build_DASH_id);
...
socket.onmessage = ((function (url,socket,WebSocket,temp__5455__auto__,map__68251,map__68251__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
});})(url,socket,WebSocket,temp__5455__auto__,map__68251,map__68251__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__5455__auto__,map__68251,map__68251__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__5455__auto__,map__68251,map__68251__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__68251,map__68251__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__68251,map__68251__$1,opts,retry_count,retried_count,websocket_url,build_id))
...
socket.onerror = ((function (url,socket,WebSocket,temp__5455__auto__,map__68251,map__68251__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1545335809604
