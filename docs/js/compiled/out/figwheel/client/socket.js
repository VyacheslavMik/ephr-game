...
}catch (e56184){if((e56184 instanceof Error)){
var e = e56184;
return null;
} else {
throw e56184;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__56185){
var map__56186 = p__56185;
var map__56186__$1 = (((((!((map__56186 == null))))?(((((map__56186.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56186.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56186):map__56186);
var opts = map__56186__$1;
var retry_count = cljs.core.get.call(null,map__56186__$1,cljs.core.cst$kw$retry_DASH_count);
var retried_count = cljs.core.get.call(null,map__56186__$1,cljs.core.cst$kw$retried_DASH_count);
var websocket_url = cljs.core.get.call(null,map__56186__$1,cljs.core.cst$kw$websocket_DASH_url);
var build_id = cljs.core.get.call(null,map__56186__$1,cljs.core.cst$kw$build_DASH_id);
...
socket.onmessage = ((function (url,socket,WebSocket,temp__5455__auto__,map__56186,map__56186__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
});})(url,socket,WebSocket,temp__5455__auto__,map__56186,map__56186__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__5455__auto__,map__56186,map__56186__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__5455__auto__,map__56186,map__56186__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__56186,map__56186__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__56186,map__56186__$1,opts,retry_count,retried_count,websocket_url,build_id))
...
socket.onerror = ((function (url,socket,WebSocket,temp__5455__auto__,map__56186,map__56186__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1545321278070
